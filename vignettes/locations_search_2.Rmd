...
### User mention network analysis for Boston with some nice plots
...
#### Interactive Boston User mention network visualization with sigmajs
...
#### Interactive Boston User mention network visualization with visNetwork
```{r ewal = FALSE, fig.width=7, fig.height=7}
# Not Run
if(nrow(usermentions.df) > 0){
...
### Retweet network analysis for Boston
...
#### Interactive Boston Retweet network visualization with sigmajs
...
#### Interactive Boston Retweet network visualization with visNetwork
```{r eval = FALSE, fig.width=7, fig.height=7}
# Not Run
if(nrow(retweets.df) > 0){
