...
names(tophashtags.dem) = c("Dem.Hashtag","Count")
...
names(tophashtags.rep) = c("Rep.Hashtag","Count")
...
knitr::kable(
  data.frame(
    Screen_Name = topusermentions.dem$user_mention_screen_name,
...
knitr::kable(
  data.frame(
    Screen_Name = topusermentions.rep$user_mention_screen_name,
